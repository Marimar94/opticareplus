...
('Juan', 'Pérez', 28, 'Masculino', 'Ingeniero', 'Calle Falsa 123', 'Ciudad de México', 'CDMX', 5551234567, 'Paciente con miopía, requiere lentes de -2.50 dioptrías.'),
('María', 'Gómez', 34, 'Femenino', 'Doctora', 'Avenida Siempreviva 456', 'Guadalajara', 'Jalisco', 5552345678, 'Paciente con astigmatismo, necesita lentes tóricos.'),
('Carlos', 'López', 45, 'Masculino', 'Arquitecto', 'Boulevard de los Sueños Rotos 789', 'Monterrey', 'Nuevo León', 5553456789, 'Presbicia detectada, requiere lentes bifocales.'),
('Ana', 'Martínez', 29, 'Femenino', 'Diseñadora Gráfica', 'Calle Luna 101', 'Puebla', 'Puebla', 5554567890, 'Paciente con ojo seco, recomendar lágrimas artificiales.'),
('Luis', 'Rodríguez', 50, 'Masculino', 'Abogado', 'Avenida Libertad 202', 'Tijuana', 'Baja California', 5555678901, 'Catarata incipiente en ojo izquierdo, seguimiento requerido.'),
('Sofía', 'Hernández', 22, 'Femenino', 'Estudiante', 'Calle Sol 303', 'Cancún', 'Quintana Roo', 5556789012, 'Miopía progresiva, revisión en 6 meses.'),
('Miguel', 'Díaz', 38, 'Masculino', 'Contador', 'Avenida Reforma 404', 'Mérida', 'Yucatán', 5557890123, 'Paciente con hipermetropía, lentes de +1.75 dioptrías.'),
('Lucía', 'Moreno', 27, 'Femenino', 'Enfermera', 'Calle Estrella 505', 'Oaxaca', 'Oaxaca', 5558901234, 'Conjuntivitis alérgica, tratamiento con antihistamínicos.'),
('Jorge', 'García', 33, 'Masculino', 'Programador', 'Avenida Juárez 606', 'Querétaro', 'Querétaro', 5559012345, 'Paciente con visión borrosa, posible queratocono.'),
('Fernanda', 'Sánchez', 40, 'Femenino', 'Psicóloga', 'Calle Arcoiris 707', 'San Luis Potosí', 'San Luis Potosí', 5550123456, 'Astigmatismo y miopía combinados, lentes complejos.'),
('Roberto', 'Ramírez', 55, 'Masculino', 'Empresario', 'Avenida Hidalgo 808', 'Toluca', 'Estado de México', 5551234509, 'Glaucoma detectado, tratamiento con gotas.'),
('Patricia', 'Flores', 31, 'Femenino', 'Maestra', 'Calle Primavera 909', 'Veracruz', 'Veracruz', 5552345601, 'Paciente con diplopía, requiere evaluación neurológica.'),
('Daniel', 'Cruz', 26, 'Masculino', 'Fotógrafo', 'Avenida Revolución 1010', 'Chihuahua', 'Chihuahua', 5553456702, 'Sensibilidad a la luz, recomendar lentes fotocromáticos.'),
('Gabriela', 'Ortíz', 42, 'Femenino', 'Dentista', 'Calle Roble 1111', 'Culiacán', 'Sinaloa', 5554567803, 'Paciente con degeneración macular, seguimiento anual.'),
('Ricardo', 'Mendoza', 47, 'Masculino', 'Ingeniero Civil', 'Avenida Universidad 1212', 'Hermosillo', 'Sonora', 5555678904, 'Paciente con visión doble, posible estrabismo.');
...
('Tom Ford', 'FT5401', 'Marrón', 'TF03', 'Metal', 10, 'Caballero', 280.00, '2023-10-02', 'Disponible', NULL),
...
('Polaroid', 'PLD 4059/S', 'Azul', 'PO01', 'Plástico', 11, 'Niño', 80.00, '2023-10-10', 'Disponible', NULL),
...
('Persol', 'PO3225S', 'Marrón', 'PE01', 'Acetato', 10, 'Caballero', 240.00, '2023-10-13', 'Disponible', NULL),
...
CREATE TABLE HistorialClinico (
    ...
    idInventario INT,
    idHistorialTipoLente INT,  
    idHistorialMaterial INT,   
    ...
    FOREIGN KEY (idHistorialTipoLente) REFERENCES Historial_TipoLente(idHistorialTipoLente),
    FOREIGN KEY (idHistorialMaterial) REFERENCES Historial_Material(idHistorialMaterial)
);
